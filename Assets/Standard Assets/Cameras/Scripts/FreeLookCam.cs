...
namespace UnityStandardAssets.Cameras
{
    public class FreeLookCam : PivotBasedCameraRig
    {
        ...
        [SerializeField]
        private float m_LookMax = 75f;                       // The maximum value of the x axis rotation of the pivot.
        [SerializeField]
        private float m_LookMin = 75f;                       // The minimum value of the x axis rotation of the pivot.
        [SerializeField]
