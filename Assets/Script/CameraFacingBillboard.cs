...
public class CameraFacingBillboard : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        myContainer.transform.parent = originalParent;
    }
    ...
    void Update()
    {
        if (amActive == true)
        {
            myContainer.transform.LookAt(myContainer.transform.position + m_Camera.transform.rotation * Vector3.back, m_Camera.transform.rotation * Vector3.forward);
        }
    }
}